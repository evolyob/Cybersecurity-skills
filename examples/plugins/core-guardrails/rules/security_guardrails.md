...
- **Frontend & Web Standards**: Enforce WHATWG HTML Living Standard & W3C CSS. Web deliverables must be self-contained HTML5 with CSS reset; markdown code blocks must strictly use balanced 4-backtick nesting to prevent DOM leaking.
